...
{
    public IReadOnlyList<IncidentBucket> BuildLast24Hours(IEnumerable<EventItem> events)
    {
    ...
    public static DateTime? TryResolveEventDate(EventItem evt)
    {
        if (evt == null)
        {
            return null;
...
public sealed class IncidentBucket
{
    ...
    public double BarHeight => Math.Max(4, Math.Min(48, TotalCount * 8));
}
